...
game/
  ...
  lib/
    create-app.js         Express app, NVIDIA proxy, serves frontend/
    rooms.js              Multiplayer rooms, sync, bot partner
    prompts.js            Host system prompts and fallbacks
    bot.js                Mock opponent behavior
  spin-bottle/            Spin-the-bottle Vite source → frontend/spin-bottle/
frontend/                 PWA client (static + ES modules shared with server)
  index.html              Application shell
  manifest.webmanifest    PWA manifest
  sw.js                   Service worker
  css/                    Mobile-first UI (styles, card-stacks, game-theatre, gfy-board)
  js/
    app.js                Client orchestration
    api.js                WebSocket + REST client
    game.js               Card rules and scenarios (imported by server)
    bac.js                BAC / drunk meter
    mobile.js             iOS UX helpers
    sidegames/            Hub and mini-games
docs/                     Product requirements and architecture (GFY)
```
